 ...
 */function ut(t){return pt({...t,state:!0,attribute:!1})}let ft=class extends at{constructor(){super(...arguments),this.language="en",this._now=Date.now()}connectedCallback(){super.connectedCallback(),this._interval=window.setInterval(()=>{this._now=Date.now()},1e3)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._interval&&(window.clearInterval(this._interval),this._interval=void 0)}_format(t){const e="nl"===this.language;if(t<=0)return e?"vertrokken":"departed";const i=Math.floor(t/3600),s=Math.floor(t%3600/60),o=e?"over":"in";return i>0?`${o} ${i}${e?"u":"h"} ${s}m`:`${o} ${s} min`}render(){if(!this.arrival)return B``;const t=new Date(this.arrival).getTime();if(Number.isNaN(t))return B``;const e=Math.round((t-this._now)/1e3);return B`<span class="countdown ${e<=0?"departed":""}"
  ...
  `,t([pt({attribute:!1})],ft.prototype,"arrival",void 0),t([pt({attribute:!1})],ft.prototype,"language",void 0),t([ut()],ft.prototype,"_now",void 0),ft=t([ct("google-transit-countdown")],ft);const gt={BUS:"mdi:bus",TRAM:"mdi:tram",SUBWAY:"mdi:subway",HEAVY_RAIL:"mdi:train",RAIL:"mdi:train",COMMUTER_TRAIN:"mdi:train",LIGHT_RAIL:"mdi:tram",FERRY:"mdi:ferry",WALK:"mdi:walk"};function _t(t){const e=Math.floor(t%60),i=Math.floor(t/60),s=i%60,o=Math.floor(i/60),n=e>0?`${e}s`:"";return o>0?`${o}h${s}m${n}`:s>0?`${s}m${n}`:n||"0s"}let mt=class extends at{constructor(){super(...arguments),this.legs=[],this.expanded=!1,this.language="en"}render(){if(!this.legs?.length)return B``;const t=this.legs.map(t=>this._spanSeconds(t)),e=t.reduce((t,e)=>t+e,0)||1,i=t.map(t=>Math.max(t/e*100,6)),s=i.map(t=>`minmax(0, ${t}fr)`).join(" ");return B`
      ...
      ${this.expanded?B`<div
          ...
          >
            ${this.legs.map(t=>B`<span title=${this._legDetailLabel(t)}
                  >${this._legDetailLabel(t)}</span
                >`)}
          </div>`:q}
    `}_legTimeLabel(t,e){return t.departure_time_local?e>0?`${t.departure_time_local} (${_t(e)})`:t.departure_time_local:""}_legDetailLabel(t){if("WALK"===t.mode||!t.departure_stop||!t.arrival_stop)return"";const e="nl"===this.language,i=t.stop_count?` · ${t.stop_count} ${e?1===t.stop_count?"halte":"haltes":1===t.stop_count?"stop":"stops"}`:"";return`${t.departure_stop} → ${t.arrival_stop}${i}`}_spanSeconds(t){if(t.departure_time&&t.arrival_time){const e=new Date(t.arrival_time).getTime()-new Date(t.departure_time).getTime();if(!Number.isNaN(e)&&e>=0)return Math.round(e/1e3)}return t.duration||0}};mt.styles=r`
    .bar {
      display: grid;
  ...
  `,t([pt({attribute:!1})],mt.prototype,"legs",void 0),t([pt({attribute:!1})],mt.prototype,"expanded",void 0),t([pt({attribute:!1})],mt.prototype,"language",void 0),mt=t([ct("google-transit-journey-bar")],mt);const $t=r`
  :host {
    display: block;
  }
